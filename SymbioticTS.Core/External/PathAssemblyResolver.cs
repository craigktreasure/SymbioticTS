...
// Original: https://github.com/dotnet/corefx/blob/master/src/System.Reflection.MetadataLoadContext/src/System/Reflection/PathAssemblyResolver.cs
        ...
        public PathAssemblyResolver(IEnumerable<string> assemblyPaths)
        {
            ...
            foreach (string path in assemblyPaths)
            {
                if (string.IsNullOrEmpty(path))
                    throw new ArgumentException($"The path {path} is not valid.", nameof(assemblyPaths));
